...
class SentenceQuizConfigPanel extends javax.swing.JPanel implements QuizConfigPanel
{
	...
	static private HashMap<String, ETypeAff> typesAff = new HashMap<String, ETypeAff>();
	{
		...
		{
			typesAff.put(epsofts.KanjiNoSensei.metier.Messages.getString(Sentence.class.getSimpleName()+".OM."+type.toString()), type); //$NON-NLS-1$
		}
	}
	...
	static private HashMap<String, ETypeSaisie> typesSaisie = new HashMap<String, ETypeSaisie>();
	{
		...
		{
			typesSaisie.put(epsofts.KanjiNoSensei.metier.Messages.getString(Sentence.class.getSimpleName()+".IM."+type.toString()), type); //$NON-NLS-1$
		}
	}
	...
	{
		jComboBoxAffQuiz.setSelectedItem(epsofts.KanjiNoSensei.metier.Messages.getString(Sentence.class.getSimpleName()+".OM."+affichageElementQuiz.toString())); //$NON-NLS-1$
		jComboBoxSaisieReponse.setSelectedItem(epsofts.KanjiNoSensei.metier.Messages.getString(Sentence.class.getSimpleName()+".IM."+saisieReponseQuiz.toString())); //$NON-NLS-1$
		jComboBoxSaisieReponseChoixAff.setSelectedItem(epsofts.KanjiNoSensei.metier.Messages.getString(Sentence.class.getSimpleName()+".OM."+affichageChoixReponsesQuiz.toString())); //$NON-NLS-1$
		jComboBoxAffReponse.setSelectedItem(epsofts.KanjiNoSensei.metier.Messages.getString(Sentence.class.getSimpleName()+".OM."+affichageReponseQuiz.toString())); //$NON-NLS-1$
	}
	...
	{
		affichageElementQuiz = ETypeAff.valueOf(Config.getString("SentenceQuizConfig.affichageElementQuiz", ETypeAff.Signification.toString())); //$NON-NLS-1$
		saisieReponseQuiz = ETypeSaisie.valueOf(Config.getString("SentenceQuizConfig.saisieReponseQuiz", ETypeSaisie.AttenteClick.toString())); //$NON-NLS-1$
		affichageChoixReponsesQuiz = ETypeAff.valueOf(Config.getString("SentenceQuizConfig.affichageChoixReponsesQuiz", ETypeAff.Kanji.toString())); //$NON-NLS-1$
		affichageReponseQuiz = ETypeAff.valueOf(Config.getString("SentenceQuizConfig.affichageReponseQuiz", ETypeAff.Detaille.toString())); //$NON-NLS-1$
	}
	
	private void saveConfig()
	{
		Config.setString("SentenceQuizConfig.affichageElementQuiz", affichageElementQuiz.toString()); //$NON-NLS-1$
		Config.setString("SentenceQuizConfig.saisieReponseQuiz", saisieReponseQuiz.toString()); //$NON-NLS-1$
		Config.setString("SentenceQuizConfig.affichageChoixReponsesQuiz", affichageChoixReponsesQuiz.toString()); //$NON-NLS-1$
		Config.setString("SentenceQuizConfig.affichageReponseQuiz", affichageReponseQuiz.toString()); //$NON-NLS-1$
	}
