...
public class TristateCheckBox extends JCheckBox
{
	...
	public void paint(Graphics g)
	{
		...
		g.draw3DRect(4, 4, w, h, true);

		if (bgColor != null)
		{
			g.setColor(bgColor);
			g.fillRect(5, 5, w - 1, h - 1);
		}

		if (checkColor != null)
		{
			g.setColor(checkColor);
			g.drawString("x", 8, 15); //$NON-NLS-1$
		}
	...
	private class TristateDecorator implements ButtonModel
	{
		 ...
		 * 
		 * @param ignoreDontCare
		 */
		private void nextState(boolean ignoreDontCare)
		{
